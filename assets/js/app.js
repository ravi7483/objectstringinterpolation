...
var minimum = {
	...
	reacting : "that a reacting or flowing",
	activated : "the activated complex is considered to have been formed in a state",
	equilibrium : "of equilibrium with the atoms or molecules",
	therefore : "and therefore its statistical and thermodynamic",
	rate : "The rate at which the final state is attained is",
	quantities : "These quantities may be calculated for",
	principles : "In this way the rate constant of a chemical or physical process",
	Transition :"state theory can also be formulated",
}

var minimum1 = "it represents the " + minimum.energy + " " + minimum.reacting + " system must acquire for the transformation to take place. In transition-state theory, " + minimum.activated + " " + minimum.equilibrium + " is considered to have been formed in a state of equilibrium with the atoms or molecules in the initial state, " + minimum.therefore + " properties can be specified. " +  minimum.rate +" determined by the number of activated complexes formed and the frequency with which they go over to the final state. These quantities may be calculated for simple systems by using statistical-mechanical principles. " + minimum.quantities + " simple systems by using statistical-mechanical principles. " + minimum.principles + " may be expressed in terms of atomic and molecular dimensions, atomic masses, and interatomic or intermolecular forces. Transition " + minimum.Transition + " in thermodynamic terms.";
